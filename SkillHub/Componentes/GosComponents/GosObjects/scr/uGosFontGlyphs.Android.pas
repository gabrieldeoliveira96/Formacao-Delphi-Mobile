...
var
  ...
  FontFile: string;
begin
  FPaint := TGosView.GetRttiValue<JPaint>(Self, 'FPaint');
  ...
  try
    ...
    try
      ...
      //
      TGosView.SetRttiValue<Integer>(Self, 'FTop', Metrics.top);
      TGosView.SetRttiValue<Integer>(Self, 'FAscent', Metrics.ascent);
      TGosView.SetRttiValue<Integer>(Self, 'FDescent', Metrics.descent);
      TGosView.SetRttiValue<Integer>(Self, 'FBottom', Metrics.bottom);
      TGosView.SetRttiValue<Integer>(Self, 'FLeading', Metrics.leading);
      {
      FTop := Metrics.top;
