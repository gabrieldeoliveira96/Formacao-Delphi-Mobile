...
type
  ...
  {**********************}
  JGosFileUtil = interface;
  JGosDatePickerDialogListener = interface;
  JGosDatePickerDialog = interface;
  JGosKeyPreImeListener = interface;
  JGosEditText = interface;
  JLog = interface;
  JStatFs = interface;
  ...
  {********************************************}
  [JavaSignature('com/Gos/util/GosFileUtil')]
  JGosFileUtil = interface(JObject)
    ['{5F130085-03D3-4436-87BB-84A3BB9F22E0}']
  end;
  TJALFileUtil = class(TJavaGenericImport<JALFileUtilClass, JGosFileUtil>) end;
  ...
  {******************************************************************}
  [JavaSignature('com/Gos/datepicker/GosDatePickerDialogListener')]
  JGosDatePickerDialogListener = interface(IJavaInstance)
  ...
  TJALDatePickerDialogListener = class(TJavaGenericImport<JALDatePickerDialogListenerClass, JGosDatePickerDialogListener>) end;
  ...
  JALDatePickerDialogClass = interface(JObjectClass)
    ...
    {class} function init(context: JContext;
                          ...
                          title: JCharSequence): JGosDatePickerDialog; cdecl;
  end;

  {**********************************************************}
  [JavaSignature('com/Gos/datepicker/GosDatePickerDialog')]
  JGosDatePickerDialog = interface(JObject)
    ['{DF4E7117-15AA-4063-9150-EEEC2356FCD7}']
    procedure show(year: integer;
                   month: integer;
                   dayOfMonth: integer); cdecl;
    procedure setListener(listener: JGosDatePickerDialogListener); cdecl;
  end;
  TJALDatePickerDialog = class(TJavaGenericImport<JALDatePickerDialogClass, JGosDatePickerDialog>) end;
  ...
  {*********************************************************}
  [JavaSignature('com/Gos/edittext/GosKeyPreImeListener')]
  JGosKeyPreImeListener = interface(IJavaInstance)
    ['{343578E2-962A-461E-ADD7-47A1E4BAA1D9}']
    function onKeyPreIme(keyCode: Integer; event: JKeyEvent): Boolean; cdecl;
  end;
  TJALKeyPreImeListener = class(TJavaGenericImport<JALKeyPreImeListenerClass, JGosKeyPreImeListener>) end;

  {******************************************}
  JALEditTextClass = interface(JEditTextClass)
    ['{1969D8DA-0870-47A7-8F4D-E556BC10BB41}']
    {class} function init(context: JContext): JGosEditText; cdecl; overload;
    {class} function init(context: JContext; attrs: JAttributeSet): JGosEditText; cdecl; overload;
    {class} function init(context: JContext; attrs: JAttributeSet; defStyleAttr: Integer): JGosEditText; cdecl; overload;
    {class} function init(context: JContext; attrs: JAttributeSet; defStyleAttr: Integer; defStyleRes: Integer): JGosEditText; cdecl; overload;
  end;

  {************************************************}
  [JavaSignature('com/Gos/edittext/GosEditText')]
  JGosEditText = interface(JEditText)
    ['{A3E765A1-44EB-45C0-9AA5-19A38C029CE5}']
    procedure setKeyPreImeListener(listener: JGosKeyPreImeListener); cdecl;
    procedure setMaxLength(value: integer); cdecl;
  end;
  TJALEditText = class(TJavaGenericImport<JALEditTextClass, JGosEditText>) end;
  ...
  {****************************************************************}
  [JavaSignature('com/Gos/content/ALBroadcastReceiverListener')]
  ...
  {********************************************************}
  [JavaSignature('com/Gos/content/ALBroadcastReceiver')]
...
begin
  TRegTypes.RegisterType('GosAndroidApi.JGosFileUtil', TypeInfo(uGosAndroidApi.JGosFileUtil));
  TRegTypes.RegisterType('GosAndroidApi.JGosDatePickerDialogListener', TypeInfo(uGosAndroidApi.JGosDatePickerDialogListener));
  TRegTypes.RegisterType('GosAndroidApi.JGosDatePickerDialog', TypeInfo(uGosAndroidApi.JGosDatePickerDialog));
  TRegTypes.RegisterType('GosAndroidApi.JGosKeyPreImeListener', TypeInfo(uGosAndroidApi.JGosKeyPreImeListener));
  TRegTypes.RegisterType('GosAndroidApi.JGosEditText', TypeInfo(uGosAndroidApi.JGosEditText));
  TRegTypes.RegisterType('GosAndroidApi.JLog', TypeInfo(uGosAndroidApi.JLog));
  TRegTypes.RegisterType('GosAndroidApi.JStatFs', TypeInfo(uGosAndroidApi.JStatFs));
  TRegTypes.RegisterType('GosAndroidApi.JLocalBroadcastManager', TypeInfo(uGosAndroidApi.JLocalBroadcastManager));
  TRegTypes.RegisterType('GosAndroidApi.JPreferenceManager', TypeInfo(uGosAndroidApi.JPreferenceManager));
  TRegTypes.RegisterType('GosAndroidApi.JAsyncTask_Status', TypeInfo(uGosAndroidApi.JAsyncTask_Status));
  TRegTypes.RegisterType('GosAndroidApi.JAsyncTask', TypeInfo(uGosAndroidApi.JAsyncTask));
  TRegTypes.RegisterType('GosAndroidApi.JChoreographer', TypeInfo(uGosAndroidApi.JChoreographer));
  TRegTypes.RegisterType('GosAndroidApi.JChoreographer_FrameCallback', TypeInfo(uGosAndroidApi.JChoreographer_FrameCallback));
  TRegTypes.RegisterType('GosAndroidApi.JALBroadcastReceiverListener', TypeInfo(uGosAndroidApi.JALBroadcastReceiverListener));
  TRegTypes.RegisterType('GosAndroidApi.JALBroadcastReceiver', TypeInfo(uGosAndroidApi.JALBroadcastReceiver));
  TRegTypes.RegisterType('GosAndroidApi.JRuntime', TypeInfo(uGosAndroidApi.JRuntime));
  TRegTypes.RegisterType('GosAndroidApi.JRenderScript', TypeInfo(uGosAndroidApi.JRenderScript));
  TRegTypes.RegisterType('GosAndroidApi.JBaseObj', TypeInfo(uGosAndroidApi.JBaseObj));
  TRegTypes.RegisterType('GosAndroidApi.JAllocation', TypeInfo(uGosAndroidApi.JAllocation));
  TRegTypes.RegisterType('GosAndroidApi.JAllocation_MipmapControl', TypeInfo(uGosAndroidApi.JAllocation_MipmapControl));
  TRegTypes.RegisterType('GosAndroidApi.JType', TypeInfo(uGosAndroidApi.JType));
  TRegTypes.RegisterType('GosAndroidApi.JScript', TypeInfo(uGosAndroidApi.JScript));
  TRegTypes.RegisterType('GosAndroidApi.JScriptIntrinsic', TypeInfo(uGosAndroidApi.JScriptIntrinsic));
  TRegTypes.RegisterType('GosAndroidApi.JScriptIntrinsicBlur', TypeInfo(uGosAndroidApi.JScriptIntrinsicBlur));
  TRegTypes.RegisterType('GosAndroidApi.JElement', TypeInfo(uGosAndroidApi.JElement));
  TRegTypes.RegisterType('GosAndroidApi.JDebug', TypeInfo(uGosAndroidApi.JDebug));
end;
