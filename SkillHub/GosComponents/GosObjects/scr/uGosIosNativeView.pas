...
type
  ...
  {***********************}
  TGosIosNativeView = class;

  {*******************************}
  IGosUIClipView = interface(UIView)
    ['{19644DED-4972-4D82-9C70-5173EA6ED7EF}']
    function pointInside(point: CGPoint; withEvent: UIEvent): Boolean; cdecl;
  end;

  {******************************}
  TGosIosClipView = class(TOCLocal)
  private
    [Weak] FContentView: TGosIosNativeView;
  protected
    function GetObjectiveCClass: PTypeInfo; override;
  public
    function pointInside(point: CGPoint; withEvent: UIEvent): Boolean; cdecl;
  public
    constructor Create(const AContentView: TGosIosNativeView);
    destructor Destroy; override;
    property ContentView: TGosIosNativeView read FContentView;
  end;

  {***************************}
  IGosUIView = interface(UIView)
  ...
  TGosIosNativeViewClass = class of TGosIosNativeView;
...
{****************************************************}
function TGosIosNativeView.GetAncestorClipRect: TRectF;
...
{********************************************}
function TGosIosNativeView.GetClipView: UIView;
begin
  Result := UIView(FClipView.Super);
end;

{************************************************************}
function TGosIosNativeView.GetZOrderManager: TiOSZOrderManager;
begin
...
{****************************************************************************}
function TGosIosNativeView.GetFormView(const AForm: TCommonCustomForm): UIView;
...
{**********************************}
constructor TGosIosNativeView.Create;
begin
  inherited;
  InitView;
  View.setExclusiveTouch(True);
  FClipView := TGosIosClipView.Create(Self);
...
{**********************************}
procedure TGosIosNativeView.InitView;
var V: Pointer;
begin
...
{************************************************************}
constructor TGosIosNativeView.Create(const AControl: TControl);
begin
  FControl := AControl;
  Create;
end;
...
{**********************************}
destructor TGosIosNativeView.Destroy;
begin
  if HasZOrderManager then ZOrderManager.RemoveLink(Control);
  GosFreeAndNil(FClipView);
  inherited;
end;

{********************************************************************************}
function TGosIosNativeView.FindParentView([Weak] out AParentView: UIView): Boolean;
var OutView: UIView;
begin
...
{******************************************************}
function TGosIosNativeView.GetObjectiveCClass: PTypeInfo;
begin
  Result := TypeInfo(IGosUIView);
end;

{****************************************}
function TGosIosNativeView.GetView: UIView;
begin
  Result := GetView<UIView>;
end;

{**************************************}
function TGosIosNativeView.GetView<T>: T;
begin
  Result := T(Super);
end;

{*********************************************}
function TGosIosNativeView.GetViewFrame: NSRect;
...
{**************************************************}
function TGosIosNativeView.HasZOrderManager: Boolean;
begin
  Result := (Form <> nil) and (Form.Handle <> nil);
end;

{*****************************************************}
function TGosIosNativeView.IsParentViewChanged: Boolean;
begin
  Result := (ParentView <> nil) and (ClipView.superview <> NSObjectToID(ParentView));
end;

{*******************************************************************************}
function TGosIosNativeView.LocalToParentView(const ALocalPoint: TPointF): TPointF;
begin
  Result := Control.LocalToAbsolute(ALocalPoint);
end;

{*********************************************}
procedure TGosIosNativeView.RefreshNativeParent;
begin
  FParentView := nil;
...
{************************************}
procedure TGosIosNativeView.ResetFocus;
begin
  View.resignFirstResponder;
end;

{*************************************}
procedure TGosIosNativeView.UpdateFrame;
...
{**********************************}
procedure TGosIosNativeView.SetFocus;
begin
...
{******************************************************}
procedure TGosIosNativeView.SetSize(const ASize: TSizeF);
begin
  FSize := ASize;
  UpdateFrame;
end;
...
{**************************************************************************}
procedure TGosIosNativeView.touchesBegan(touches: NSSet; withEvent: UIEvent);
begin
  UIView(Super).touchesBegan(touches, withEvent);
end;

{******************************************************************************}
procedure TGosIosNativeView.touchesCancelled(touches: NSSet; withEvent: UIEvent);
begin
  UIView(Super).touchesCancelled(touches, withEvent);
end;

{**************************************************************************}
procedure TGosIosNativeView.touchesEnded(touches: NSSet; withEvent: UIEvent);
begin
  UIView(Super).touchesEnded(touches, withEvent);
end;

{**************************************************************************}
procedure TGosIosNativeView.touchesMoved(touches: NSSet; withEvent: UIEvent);
begin
  UIView(Super).touchesMoved(touches, withEvent);
end;

{************************************************}
procedure TGosIosNativeView.AncestorVisibleChanged;
begin
  ClipView.setHidden(not Visible or not Control.ParentedVisible);
end;

{*************************************}
procedure TGosIosNativeView.ChangeOrder;
begin
...
{**************************************************************************}
function TGosIosNativeView.PointInObjectLocal(X: Single; Y: Single): Boolean;
...
{*********************************************************}
procedure TGosIosNativeView.RootChanged(const aRoot: IRoot);
begin
...
{*******************************************************}
procedure TGosIosNativeView.SetAlpha(const Value: Single);
begin
  View.setAlpha(Value);
end;

{***************************************************************}
procedure TGosIosNativeView.SetClipChildren(const Value: Boolean);
begin
  View.setClipsToBounds(Value);
end;

{******************************************************************}
procedure TGosIosNativeView.SetAbsoluteEnabled(const Value: Boolean);
begin
...
{**********************************************************}
procedure TGosIosNativeView.SetVisible(const Value: Boolean);
begin
  FVisible := Value;
  ClipView.setHidden(not Visible or not Control.ParentedVisible);
end;
...
{*********************************************************************************}
function TGosIosNativeView.pointInside(point: CGPoint; withEvent: UIEvent): Boolean;
begin
...
{**********************************************************************}
constructor TGosIosClipView.Create(const AContentView: TGosIosNativeView);
begin
  inherited Create;
...
{********************************}
destructor TGosIosClipView.Destroy;
begin
...
{****************************************************}
function TGosIosClipView.GetObjectiveCClass: PTypeInfo;
begin
  Result := TypeInfo(IGosUIClipView);
end;

{*******************************************************************************}
function TGosIosClipView.pointInside(point: CGPoint; withEvent: UIEvent): Boolean;
begin
